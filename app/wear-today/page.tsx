    ...
    <div className="space-y-6">
      <div className="rounded-xl border p-5">
        ...
        <div className="mt-4 grid gap-3 md:grid-cols-4">
          <Input value={occasion} onChange={(e) => setOccasion(e.target.value)} placeholder="occasion" />
          <Input value={styleVibe} onChange={(e) => setStyleVibe(e.target.value)} placeholder="style vibe" />
