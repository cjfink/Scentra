...
export default async function HomePage() {
  ...
  return (
    <section className="mx-auto max-w-4xl py-16 text-center sm:py-24">
      <p className="mx-auto w-fit rounded-full border border-border bg-card/80 px-4 py-1 text-xs font-medium tracking-wide text-muted-foreground">
      ...
      <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-muted-foreground">
        Track your collection, share your scent of the day, and discover
        weather-aware recommendations in a cleaner, calmer experience.
      </p>
